...
class features_extractor:
    ...
    def extract(self, image):
        ...
        VECTOR = np.concatenate([geom_features, stat_features, visual_features, np.array(medidas)])
    ...
    def largo_ancho(self,img):
        ...
        # ✅ INICIALIZAR vector con ceros por si no hay contornos válidos
        vector = [0, 0, 0, 0]
        ...
        for c in contornos:
            ...
            # ✅ ACTUALIZAR el vector (no retornar todavía)
            vector = [x, y, ancho, alto]
            
            # ✅ SOLO retornar después de procesar el contorno válido
            # Si quieres el contorno más grande, usa break aquí
            break  # Descomenta si solo quieres el primer contorno válido
        
        # ✅ RETORNAR fuera del bucle (siempre retorna algo)
